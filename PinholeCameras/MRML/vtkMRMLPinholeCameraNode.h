...
Program:   3D Slicer
Module:    $RCSfile: vtkMRMLPinholeCameraNode.h,v $
Date:      $Date: 2018/6/16 10:54:09 $
Version:   $Revision: 1.0 $

=========================================================================auto=*/

#ifndef __vtkMRMLPinholeCameraNode_h
#define __vtkMRMLPinholeCameraNode_h
...
class VTK_SLICER_PINHOLECAMERAS_MODULE_MRML_EXPORT vtkMRMLPinholeCameraNode : public vtkMRMLStorableNode
{
public:
  enum
  {
...
public:
  static vtkMRMLPinholeCameraNode* New();
  vtkTypeMacro(vtkMRMLPinholeCameraNode, vtkMRMLStorableNode);
  ...
  virtual const char* GetNodeTagName() override {return "PinholeCamera";};
...
protected:
  vtkMRMLPinholeCameraNode();
  ~vtkMRMLPinholeCameraNode();
  vtkMRMLPinholeCameraNode(const vtkMRMLPinholeCameraNode&);
  void operator=(const vtkMRMLPinholeCameraNode&);
